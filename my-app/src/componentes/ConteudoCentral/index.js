  ...
  return(
    <div>
      <div  className='box__header'>
        ...
        <div><img id="imagem" src={imagem1} alt="" /></div>
        <div><img id="imagem" src={imagem2} alt="" /></div>
        <div><img id="imagem" src={imagem3} alt="" /></div>
        <div><img id="imagem" src={imagem4} alt="" /></div>
        <div><img id="imagem" src={imagem5} alt="" /></div>
        <div><img id="imagem" src={imagem6} alt="" /></div>
        <div><img id="imagem" src={imagem7} alt="" /></div>
        </div>
